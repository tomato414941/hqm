...
`CLAUDE.md` is kept as a compatibility filename and should mirror this file.
...
- Keep commit-target rules in this file (`AGENTS.md`).
- Keep machine-specific notes in `AGENTS.override.md` or `CLAUDE.local.md`.
- Local-only files must stay gitignored.
